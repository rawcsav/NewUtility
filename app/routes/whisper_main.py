...
from flask import Blueprint, request, get_flashed_messages, render_template, flash, redirect, url_for, session, \
    send_from_directory
...
def results():
    ...
    try:
        ...
        txt_files_relative = [os.path.relpath(txt_file, project_root_directory) for txt_file in txt_files]
    ...
    return render_template("whisper_results.html", files=txt_files_relative, output_directory=output_directory)
